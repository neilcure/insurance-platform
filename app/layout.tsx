...
const jsonLdOrganization = {
  ...
  url: SITE_URL,
  // Raster URL — Google's Organization logo guidance favours crawlable
  // PNG/JPEG; `/apple-icon` is generated by `app/apple-icon.tsx` (180×180).
  // Do not use `/icon` here unless `app/icon.png` or `app/icon.tsx` exists.
